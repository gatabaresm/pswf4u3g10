    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <section class="registrar-producto">
          ...
          <form action="actualizar2.php" method="POST">
              ...
              <input type="text" class="controles" value=" <?php echo $row['nombre'] ?> " id="nombre" placeholder="Ingrese aquí el nombre del Producto" name="nombre">
              <label>Marca del Producto:</label>
              <input type="text" class="controles" value=" <?php echo $row['marca'] ?> " id="marca" placeholder="Ingrese aquí la marca del Producto" name="marca">
              <label>Precio del Producto:</label>
              <input type="text" class="controles" value=" <?php echo $row['precio'] ?> " id="precio" placeholder="Ingrese aquí el precio del Producto" name="precio">
              <label>Cantidad de Producto comprado:</label>
              <input type="text" class="controles" value=" <?php echo $row['cantidad'] ?> " id="cantidad" placeholder="Ingrese aquí la cantidad de Producto comprado" name="cantidad">
              <button type="submit" class="btn btn-primary">Modificar Producto</button>
              <a class="btn btn-danger" href="../modificar.html" role="button">Volver</a>
          </form>
      </section>
      </br>
